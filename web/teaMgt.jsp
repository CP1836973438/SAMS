...
<body>
<div>
    <form action="${pageContext.request.contextPath}/addTea" method="post" id="formId">
        <table>
            <tr>
                <td>教师工号</td>
                <td>
...
<table>
    ...
    <c:if test="${not empty teachers}">
        <c:forEach items="${teachers}" var="tm" varStatus="vs">
            <tr>
                <td>${vs.count}</td>
                <td>${tm.tid}</td>
                <td>${tm.tname}</td>
                ...
                <td>${tm.tclassVal2}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/getTea?id=${tm.id}">修改</a>
                    || <a href="${pageContext.request.contextPath}/deleteTea?id=${tm.id}">删除</a>
                </td>
            </tr>
        </c:forEach>
    </c:if>
